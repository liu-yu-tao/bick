<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\PHP\xiangmu\bick\public/../application/admin\view\article\edit.html";i:1524029798;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1523848299;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="" name="url" required="" type="url" value="<?php echo $edit['url']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="author" placeholder="" name="author" required="" type="text" value="<?php echo $edit['author']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="rec" class="col-sm-2 control-label no-padding-right">推荐</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="rec" placeholder="" name="rec" required="" type="text" value="<?php echo $edit['rec']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="desc" placeholder="" name="desc" required="" type="text" value="<?php echo $edit['desc']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
