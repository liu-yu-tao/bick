<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\PHP\xiangmu\bick\public/../application/admin\view\authrule\lst.html";i:1524110169;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524471374;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加权限" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach($arr as $adm): ?>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $adm['sort']; ?></td>
                                <td align="center" style="text-align: left">
                                    <?php if($adm['pid']!==0): ?>
                                        |
                                        <?php $__FOR_START_21486__=0;$__FOR_END_21486__=$adm['level'];for($i=$__FOR_START_21486__;$i < $__FOR_END_21486__;$i+=1){ ?>
                                        ---
                                        <?php } endif; ?>
                                    <?php echo $adm['title']; ?>
                                </td>
                                <td align="center"><?php echo $adm['name']; ?></td>
                                <td align="center"><?php echo $adm['level']; ?>级</td>
                                <td align="center">
                                    <a href="<?php echo url('authrule/edit',['id'=>$adm['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('authrule/del',['id'=>$adm['id']]); ?>')" class="btn btn-danger btn-sm shiny">
