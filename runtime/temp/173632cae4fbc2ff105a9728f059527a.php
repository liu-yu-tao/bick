<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\PHP\xiangmu\bick\public/../application/admin\view\authrule\add.html";i:1524325370;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524031424;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                            ...
                            <div class="col-sm-6">
                                <select id="group_id" name="group_id" style="width: 100%;">
                                    ...
                                    <option value="<?php echo $ass['id']; ?>">
                                        <?php if($ass['pid']!==0): ?>
                                        |
                                        <?php $__FOR_START_22495__=0;$__FOR_END_22495__=$ass['level'];for($i=$__FOR_START_22495__;$i < $__FOR_END_22495__;$i+=1){ ?>
                                        ---
                                        <?php } endif; ?>
                                        <?php echo $ass['title']; ?>
                                    </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="name" placeholder="" name="name" required="" type="name">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
