<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\phpStudy\WWW\bick\public/../application/index\view\search\search.html";i:1483854663;s:70:"F:\phpStudy\WWW\bick\public/../application/index\view\public\head.html";i:1483850372;s:72:"F:\phpStudy\WWW\bick\public/../application/index\view\public\footer.html";i:1483796785;}*/ ?>
...
<input name="keywords" type="text" style="background-color: #000000;padding-left: 10px; font-size: 12px;font-family: 'Microsoft Yahei'; color: #999999;height: 29px; width: 160px; border: solid 1px #666666; line-height: 28px;" id="go" value="在这里搜索..." onfocus="if(this.value=='在这里搜索...'){this.value='';}"  onblur="if(this.value==''){this.value='在这里搜索...';}" />
    ...
    <div id="xh_container">
        ...
        <div class="path">搜索<font style="color:red; margin:0 5px;"><?php echo $keywords; ?></font>结果：</div><div class="clear"></div>
            ...
            <?php if($keywords != ''): if(is_array($serRes) || $serRes instanceof \think\Collection): $i = 0; $__LIST__ = $serRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
...
<ul id="ulHot">
<?php if(is_array($serHot) || $serHot instanceof \think\Collection): $i = 0; $__LIST__ = $serHot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?> 
