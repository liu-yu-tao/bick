<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\PHP\xiangmu\bick\public/../application/admin\view\admin\add.html";i:1523791462;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524031424;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select id="group_id" name="group_id" style="width: 100%;">
                                    <?php foreach($add as $ass): ?>
                                    <option selected="selected" value="<?php echo $ass['id']; ?>"><?php echo $ass['title']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>  
