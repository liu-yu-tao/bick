<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\phpStudy\WWW\bick\public/../application/admin\view\conf\lst.htm";i:1480919213;s:68:"F:\phpStudy\WWW\bick\public/../application/admin\view\public\top.htm";i:1479915268;s:69:"F:\phpStudy\WWW\bick\public/../application/admin\view\public\left.htm";i:1481788756;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="flip-scroll">
                    <form action="" method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                    <?php if(is_array($confres) || $confres instanceof \think\Collection): $i = 0; $__LIST__ = $confres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td align="center"><?php echo $conf['id']; ?></td>
                                        <td align="center"><input name="<?php echo $conf['id']; ?>" type="text" style="width:50px; text-align:center;" value="<?php echo $conf['sort']; ?>"></td>
