<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"F:\PHP\xiangmu\bick\public/../application/admin\view\article\add.html";i:1524029798;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524327974;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="" name="url" required="" type="url">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
