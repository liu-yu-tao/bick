<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"F:\PHP\xiangmu\bick\public/../application/admin\view\admin\list.html";i:1523802861;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524031424;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach($admin as $adm): ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/edit',['id'=>$adm['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/del',['id'=>$adm['id']]); ?>')" class="btn btn-danger btn-sm shiny">
