<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\PHP\xiangmu\bick\public/../application/admin\view\conf\add.html";i:1524455839;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524327974;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                       <div class="form-group">
                            <label for="" class="col-sm-2 control-label no-padding-right">中文名称</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label no-padding-right">英文名称</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label no-padding-right">配置类型</label>
                            <div class="col-sm-6">
                                <select name="type">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label no-padding-right">可选值</label>
                            <div class="col-sm-6">
