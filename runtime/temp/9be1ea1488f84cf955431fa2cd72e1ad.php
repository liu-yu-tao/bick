<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"F:\PHP\xiangmu\bick\public/../application/admin\view\article\lst.html";i:1524029799;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1524327974;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach($arr as $adm): ?>

                            <tr>
                                <td align="center"><?php echo $adm['id']; ?></td>
                                <td align="center"><?php echo $adm['title']; ?></td>
                                <td align="center"><img height="30" src="http://localhost/bick/public<?php echo $adm['thumb']; ?>" alt=""></td>
                                <td align="center"><?php if($adm['author']): ?><?php echo $adm['author']; else: ?>未填写<?php endif; ?></td>
                                <td align="center"><?php if($adm['rec']==1): ?>已推荐 <?php else: ?>未推荐<?php endif; ?></td>
                                <td align="center"><?php echo $adm['catename']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('article/edit',['id'=>$adm['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('article/del',['id'=>$adm['id']]); ?>')" class="btn btn-danger btn-sm shiny">
