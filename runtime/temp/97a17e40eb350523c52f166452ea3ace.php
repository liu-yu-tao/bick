<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\PHP\xiangmu\bick\public/../application/admin\view\link\lst.html";i:1524029901;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1523848299;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="<?php echo url('admin/authrule'); ?>">
                                    <span class="menu-text">
                                        权限列表
                                    </span>
                                <i class="menu-expand"></i>
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach($arr as $adm): ?>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $adm['url']; ?></td>
                                <td align="center"><?php echo $adm['desc']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('link/edit',['id'=>$adm['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('link/del',['id'=>$adm['id']]); ?>')" class="btn btn-danger btn-sm shiny">
