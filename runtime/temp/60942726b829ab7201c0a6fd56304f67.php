<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"F:\PHP\xiangmu\bick\public/../application/admin\view\admin\add2.html";i:1524029677;s:60:"F:\PHP\xiangmu\bick\application\admin\view\layout_admin.html";i:1523848299;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" required="" type="text" value="<?php echo $edit['name']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select id="group_id" name="group_id" style="width: 100%;">
                                    <?php foreach($cha as $ass): ?>
                                    <option <?php if($ass['id']==$edit['group_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $ass['id']; ?>"><?php echo $ass['title']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>  
